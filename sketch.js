...
function setup(){
    ...
    rotator1 = Bodies.rectangle(250,-250,50,30,rotator_options);
    World.add(world,rotator1);

    rotator2 = Bodies.rectangle(250,-250,50,30,rotator_options);
    World.add(world,rotator2);

    rotator3 = Bodies.rectangle(250,-250,50,30,rotator_options);
...
function draw(){
  ...
  ellipse(particle1.position.x,particle1.position.y,0);
  ...
  push();
  translate(rotator2.position.x,rotator2.position.y,-0);
  rotate(angle2);
  rect(0,0,150,20);
  pop();
  angle2 +=0.3;
